...
describe("27001 initial - 4th step testcases", function(){
    ...
    it("basic validations/contact banner/stepper/downloading PDF", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company27init4step.pdf').should('exist');
    ...
    it("right hand side - title, files and user data", function(){
        ...
        cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName27init4step");
    ...
    describe("billing info cases", function(){
        ...
        it("billing info section", function(){
            ...
            cy.wait(5000);
                ...
                cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName27init4step LastName");
                cy.get("#user-info").find("#user-email").should("have.text", "autouser27init-step4@qq.qq");
                //check basic info accordion - first/last name and email change shouldn't change basic info data
                cy.get(".order-card").find(".company-name").should("have.text", "Company27init4step");
                cy.get("#order-details").find("#contact-person").should("have.text", "FirstName27init4step LastName");
                cy.get("#order-details").find("#email").should("have.text", "autouser27init-step4@qq.qq");
            ...
            cy.get("input[formcontrolname='email']").clear().type("autouser27init-step4@qq.qq");
    ...
    describe("edit functionality", function(){
        ...
        it("basic info - edit", function(){
            ...
            cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName27init4step edit");
            ...
            cy.get(".order-card").find(".company-name").should("have.text", "Company27init4step edit");
