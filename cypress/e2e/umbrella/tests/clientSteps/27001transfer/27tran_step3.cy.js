...
describe("27001 transfer - 3rd step testcases", function(){
    ...
    it("stepper/downloading PDF/accordion behaviours", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company27tran3step.pdf').should('exist');
        //accordion behaviour
            //pricing
    ...
    it("editing/validating changes", function(){
        ...
        cy.get(".decision-buttons").find("#cancel-button").click();
        cy.get(".order-card").find("#toggle-order-details").click();
        cy.get("#contact-person").should("have.text", "FirstName27tran3step LastName");
        cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName27tran3step LastName");
