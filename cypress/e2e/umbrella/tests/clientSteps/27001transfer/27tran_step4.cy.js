...
describe("27001 transfer - 4th step testcases", function(){
    ...
    it("basic validations/contact banner/stepper/downloading PDF", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company27tran4step.pdf').should('exist');
    ...
    it("right hand side - title, files and user data", function(){
        ...
        cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName27tran4step");
    ...
    describe("billing info cases", function(){
        ...
        it("billing info section", function(){
            ...
            cy.wait(5000);
                ...
                cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName27tran4step LastName");
                cy.get("#user-info").find("#user-email").should("have.text", "autouser27tran-step4@qq.qq");
                //check basic info accordion - first/last name and email change shouldn't change basic info data
                cy.get(".order-card").find(".company-name").should("have.text", "Company27tran4step");
                cy.get("#order-details").find("#contact-person").should("have.text", "FirstName27tran4step LastName");
                cy.get("#order-details").find("#email").should("have.text", "autouser27tran-step4@qq.qq");
            ...
            cy.get("input[formcontrolname='email']").clear().type("autouser27tran-step4@qq.qq");
    ...
    describe("edit functionality", function(){
        ...
        it("basic info - edit", function(){
            ...
            cy.get("basic-order-edit").find("estimate-questions").should("exist");
            ...
            cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName27tran4step edit");
            ...
            cy.get(".order-card").find(".company-name").should("have.text", "Company27tran4step edit");
