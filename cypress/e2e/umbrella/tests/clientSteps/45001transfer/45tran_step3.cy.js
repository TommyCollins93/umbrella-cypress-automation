...
describe("45001 transfer - 3rd step testcases", function(){
    ...
    it("basic validations", function(){
        ...
        cy.get("#binary-question-radio-5ISO_45001-iso_45001").find(".text").contains("No").click();
        cy.get("#binary-question-radio-6ISO_45001-iso_45001").find(".text").contains("No").click();
        cy.get("#binary-question-radio-7ISO_45001-iso_45001").find(".text").contains("Yes").click();
        cy.get(".submit-button").click();
        cy.get(".binary-questions-wrapper").find("binary-question-with-comment").each(($question)=>{
            cy.get($question).find(".validation-message").should("have.text", "Required");
        });
        //radiobutton questions - answered "Yes" to each - too short text
        cy.get("#binary-question-description-0ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-1ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-2ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-3ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-4ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-5ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-6ISO_45001-iso_45001").type("a");
        cy.get("#binary-question-description-7ISO_45001-iso_45001").type("a");
        cy.get(".binary-questions-wrapper").find("binary-question-with-comment").each(($question)=>{
        ...
        cy.get("#text-question-0ISO_45001-iso_45001").type("a");
        ...
        cy.get("#text-question-1ISO_45001-iso_45001").type("a");
        ...
        cy.get("#text-question-2ISO_45001-iso_45001").type("a");
        ...
        cy.get("#outsourced_process_4ISO_45001-iso_45001").type("a");
    ...
    it("contact banner/next audit date/non-comformities/last audit date+cert expiration date", function(){
        ...
        //non-comformities
        cy.get("#hasOpenNonConformities-iso_45001-certificate").find(".text").contains("Yes").click();
        cy.get("#hasCorrectiveActionPlans-iso_45001-certificate").find(".text").contains("Yes").click();
    ...
    it("stepper/downloading PDF/pop-up/accordion behaviours", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company45tran3step.pdf').should('exist');
        //pop-up - LIST ANY SPECIAL ENVIRONMENTAL OR HEALTH AND SAFETY CONSIDERATIONS APPLYING TO THE SITE
        cy.get(".with-description").find(".info-icon").click();
        cy.get(".description-card").should("exist");
        cy.get(".description-card").find(".close-icon").click();
        //accordion behaviour
            //pricing
    ...
    it("editing/validating changes", function(){
        ...
        cy.get(".decision-buttons").find("#cancel-button").click();
        cy.get(".order-card").find("#toggle-order-details").click();
        cy.get("#contact-person").should("have.text", "FirstName45tran3step LastName");
        cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName45tran3step LastName");
