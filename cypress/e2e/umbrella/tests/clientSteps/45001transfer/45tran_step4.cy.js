...
describe("45001 transfer - 4th step testcases", function(){
    ...
    it("basic validations/contact banner/stepper/downloading PDF", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company45tran4step.pdf').should('exist');
    ...
    it("right hand side - title, files and user data", function(){
        ...
        cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName45tran4step");
    ...
    describe("billing info cases", function(){
        ...
        it("billing info section", function(){
            ...
            cy.wait(5000);
                ...
                cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName45tran4step LastName");
                cy.get("#user-info").find("#user-email").should("have.text", "autouser45tran-step4@qq.qq");
                //check basic info accordion - first/last name and email change shouldn't change basic info data
                cy.get(".order-card").find(".company-name").should("have.text", "Company45tran4step");
                cy.get("#order-details").find("#contact-person").should("have.text", "FirstName45tran4step LastName");
                cy.get("#order-details").find("#email").should("have.text", "autouser45tran-step4@qq.qq");
            ...
            cy.get("input[formcontrolname='email']").clear().type("autouser45tran-step4@qq.qq");
    ...
    describe("edit functionality", function(){
        ...
        it("basic info - edit", function(){
            ...
            cy.get("order-details").find("#change-button").click();
                ...
                cy.get("#hasCertificate_ISO_45001").find(".text").contains("No").click(); //"No" for initial
                cy.get(".audit-type-change-dialog").should("exist");
                cy.get(".audit-type-change-dialog").find(".dialog-buttons").contains("Cancel").click();
                // cy.get("#hasCertificate_ISO_45001").find("input[value='true']").eq(0).should("exist"); //sprawdź czy asercja działa
                // cy.get("#hasCertificate_ISO_45001 input").eq(0).should("have.attr", "value", "true"); //sprawdź czy inaczej zdefiniowana asercja działa
                ...
                cy.get("input[formcontrolname='customCbNameISO_45001']").type("Edit fields");
                /**/
                cy.get('#company-description_-iso_45001').type(" edit");
                cy.get("#part-time-employees-included-iso_45001").find(".text").contains("No").click();
                cy.get("#shifts_iso_45001").find(".text").contains("More").click();
                cy.get("#shifts-number-more_iso_45001").click().find(".ng-option-label").contains("4").click();
            //
            ...
            cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName45tran4step edit");
            ...
            cy.get(".order-card").find(".company-name").should("have.text", "Company45tran4step edit");
            ...
            cy.get("order-details").find("#change-button").click();
                ...
                cy.get('#total-employeesiso_45001').clear().type("1000");
                cy.get("#scope-description-needs-narrowing--iso_45001").find(".text").contains("No").click();
                cy.get("#scope-description--iso_45001").type("Edit testing note");
                ...
                cy.get(".ng-dropdown-panel-items").find("#item-5-iso_45001").click();
                /**/
            ...
            it("additional questions - edit", function(){
                ...
                //section visibility
                cy.get(".additional-questions-card").find("#toggle-order-details").click();
                cy.get(".additional-questions-card").find("transfer-additional-questions-details").should("exist");
                ...
                cy.get(".additional-questions-card").find("#change-button").click();
                    ...
                    cy.get("#decline-offer-button").should("have.attr", "disabled");
                    cy.get(".submit-button").should("have.attr", "disabled");
                cy.get(".audit-date-row").find(".clear-icon").click();
                cy.get("#transfer-reason-iso_45001-certificate").type(" and another reason");
                cy.get("#isCurrentCertificationBodyAccredited-iso_45001-certificate").find(".text").contains("Yes").click();
                cy.get("#hasOpenNonConformities-iso_45001-certificate").find(".text").contains("No").click();
                cy.get("#last-audit-performed-date").click();
                cy.get(".cdk-overlay-pane").find(".day-cell").contains("4").click();
                cy.get("#expiration-date").click();
                cy.get(".cdk-overlay-pane").find(".day-cell").contains("24").click();
                //======
                ...
                cy.get("#binary-question-radio-0ISO_45001-iso_45001").find(".text").contains("Yes").click();
                cy.get("#binary-question-description-0ISO_45001-iso_45001").type("Some secutity issues.");
                cy.get("#binary-question-radio-1ISO_45001-iso_45001").find(".text").contains("No").click();
                cy.get("#binary-question-radio-2ISO_45001-iso_45001").find(".text").contains("Yes").click();
                cy.get("#binary-question-description-2ISO_45001-iso_45001").type("Some risks.");
                cy.get("#binary-question-radio-3ISO_45001-iso_45001").find(".text").contains("No").click();
                cy.get("#binary-question-radio-4ISO_45001-iso_45001").find(".text").contains("Yes").click();
                cy.get("#binary-question-description-4ISO_45001-iso_45001").type("Receiving services.");
                cy.get("#text-question-0ISO_45001-iso_45001").type(", platinum");
                cy.get("#text-question-1ISO_45001-iso_45001").type(" Etc.");
                cy.get("#text-question-2ISO_45001-iso_45001").type(" Edit1.");
