...
describe("NOT A TEST - revert edit changes", function(){
    ...
    it("NOT A TEST - revert edit changes - 9001 transfer 4th step", function(){
        ...
        //
        cy.get("basic-order-edit").find('input[formcontrolname="firstName"]').clear().type("FirstName9tran4step");
        ...
        cy.get("basic-order-edit").find('input[formcontrolname="companyName"]').clear().type("Company9tran4step");
        ...
        cy.get("#transfer-reason-iso_9001-certificate").clear().type("Some reason");
