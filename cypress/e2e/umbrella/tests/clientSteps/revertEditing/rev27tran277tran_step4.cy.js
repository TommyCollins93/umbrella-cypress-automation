...
describe("NOT A TEST - revert edit changes", function(){
    ...
    it("NOT A TEST - revert edit changes - 27001 and 27701 transfer 4th step", function(){
        ...
        //
        cy.get("basic-order-edit").find('input[formcontrolname="firstName"]').clear().type("FirstName27and277tran4step");
        ...
        cy.get("basic-order-edit").find('input[formcontrolname="companyName"]').clear().type("Company27and277tran4step");
        ...
        cy.get("#transfer-reason-iso_27701-certificate").clear().type("Some another reason");
        ...
        cy.get("#text-question-0ISO_27701-iso_27701").clear().type("Some kind of description.");
        cy.get("#text-question-1ISO_27701-iso_27701").clear().type("Lots of controls.");
        //
