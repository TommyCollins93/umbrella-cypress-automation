...
describe("NOT A TEST - revert edit changes", function(){
    ...
    it("NOT A TEST - revert edit changes - 45001 transfer 3rd step", function(){
        ...
        //
        cy.get('input[formcontrolname="firstName"]').clear().type("FirstName45tran3step");
        ...
        cy.get('input[formcontrolname="companyName"]').clear().type("Company45tran3step");
