...
describe("NOT A TEST - revert edit changes", function(){
    ...
    it("NOT A TEST - revert edit changes - 27001 initial 4th step", function(){
        ...
        //
        cy.get("basic-order-edit").find('input[formcontrolname="firstName"]').clear().type("FirstName27init4step");
        ...
        cy.get("basic-order-edit").find('input[formcontrolname="companyName"]').clear().type("Company27init4step");
