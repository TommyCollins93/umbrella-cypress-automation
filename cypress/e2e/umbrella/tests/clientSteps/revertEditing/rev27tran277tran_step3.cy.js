...
describe("NOT A TEST - revert edit changes", function(){
    ...
    it("NOT A TEST - revert edit changes - 27001 and 27701 transfer 3rd step", function(){
        ...
        //
        cy.get('input[formcontrolname="firstName"]').clear().type("FirstName27and277tran3step");
        ...
        cy.get('input[formcontrolname="companyName"]').clear().type("Company27and277tran3step");
