...
describe("14001 transfer - 4th step testcases", function(){
    ...
    it("basic validations/contact banner/stepper/downloading PDF", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company14tran4step.pdf').should('exist');
    ...
    it("right hand side - title, files and user data", function(){
        ...
        cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName14tran4step");
...
//usuń kom.!!!! cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName14tran4step LastName");
                cy.get("#user-info").find("#user-email").should("have.text", "autouser14tran-step4@qq.qq");
                //check basic info accordion - first/last name and email change shouldn't change basic info data
                cy.get(".order-card").find(".company-name").should("have.text", "Company14tran4step");
                cy.get("#order-details").find("#contact-person").should("have.text", "FirstName14tran4step LastName");
                cy.get("#order-details").find("#email").should("have.text", "autouser14tran-step4@qq.qq");
            ...
            cy.get("input[formcontrolname='email']").clear().type("autouser14tran-step4@qq.qq");
...
//usuń kom.!!!! cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName14tran4step LastName");
            ...
            cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName14tran4step edit");
            ...
            cy.get(".order-card").find(".company-name").should("have.text", "Company14tran4step edit");
            ...
            cy.get("order-details").find("#change-button").click();
                ...
                cy.get(".ng-dropdown-panel-items").find("#item-8-iso_14001").click();
                /**/
            ...
            it("additional questions - edit", function(){
                ...
                cy.get("#transfer-reason-iso_14001-certificate").type(" and another reason");
                cy.get("#isCurrentCertificationBodyAccredited-iso_14001-certificate").find(".text").contains("Yes").click();
                cy.get("#hasOpenNonConformities-iso_14001-certificate").find(".text").contains("No").click();
                ...
                cy.get("#binary-question-description-0ISO_14001-iso_14001").type("Some secutity issues.");
                cy.get("#binary-question-radio-1ISO_14001-iso_14001").find(".text").contains("No").click();
                cy.get("#binary-question-radio-2ISO_14001-iso_14001").find(".text").contains("Yes").click();
                cy.get("#binary-question-description-2ISO_14001-iso_14001").type("Some risks.");
                cy.get("#binary-question-radio-3ISO_14001-iso_14001").find(".text").contains("No").click();
                cy.get("#binary-question-radio-4ISO_14001-iso_14001").find(".text").contains("Yes").click();
                cy.get("#binary-question-description-4ISO_14001-iso_14001").type("Receiving services.");
                cy.get("#text-question-0ISO_14001-iso_14001").type(", platinum");
