...
describe("9001 transfer - 3rd step - calculations", function(){
    ...
    it("low risk, 200 total employees, max. positive % reduction, no catastrophic risk, recert", function(){
        ...
        */
        ...
        cy.get("price-change-approve").find("price-card").eq(0).find("[id='audit-days-1']").eq(0).should("have.text", " 2 onsite audit day");
        ...
        cy.get("price-change-approve").find("price-card").eq(1).find("[id='audit-days-2']").eq(0).should("have.text", " 2 onsite audit day");
        ...
        cy.get("price-change-approve").find("price-card").eq(2).find("[id='audit-days-3']").eq(0).should("have.text", " 3.5 onsite audit day");
        ...
        cy.get(".order-pricing").find("price-card").eq(0).find("[id='audit-days-1']").eq(0).should("have.text", " 2 onsite audit day");
        ...
        cy.get(".order-pricing").find("price-card").eq(1).find("[id='audit-days-2']").eq(0).should("have.text", " 2 onsite audit day");
        ...
        cy.get(".order-pricing").find("price-card").eq(2).find("[id='audit-days-3']").eq(0).should("have.text", " 3.5 onsite audit day");
    ...
    it("high risk, 2000 total employees, -10% reduction, catastrophic risk, surv 2", function(){
        ...
        */
        ...
        cy.get("price-change-approve").find("price-card").eq(0).find("[id='audit-days-1']").eq(0).should("have.text", " 9 onsite audit day");
        cy.get("price-change-approve").find("price-card").eq(0).find("[id='certification-fee-price-1']").should("have.text", "$ 250");
        ...
        cy.get("price-change-approve").find("price-card").eq(1).find("[id='audit-days-2']").eq(0).should("have.text", " 4.5 onsite audit day");
        cy.get("price-change-approve").find("price-card").eq(1).find("[id='certification-fee-price-2']").should("have.text", "$ 250");
        ...
        cy.get("price-change-approve").find("price-card").eq(2).find("[id='audit-days-3']").eq(0).should("have.text", " 4.5 onsite audit day");
        cy.get("price-change-approve").find("price-card").eq(2).find("[id='certification-fee-price-3']").should("have.text", "$ 250");
        ...
        cy.get(".order-pricing").find("price-card").eq(0).find("[id='audit-days-1']").eq(0).should("have.text", " 9 onsite audit day");
        cy.get(".order-pricing").find("price-card").eq(0).find("[id='certification-fee-price-1']").should("have.text", "$ 250");
        ...
        cy.get(".order-pricing").find("price-card").eq(1).find("[id='audit-days-2']").eq(0).should("have.text", " 4.5 onsite audit day");
        cy.get(".order-pricing").find("price-card").eq(1).find("[id='certification-fee-price-2']").should("have.text", "$ 250");
        ...
        cy.get(".order-pricing").find("price-card").eq(2).find("[id='audit-days-3']").eq(0).should("have.text", " 4.5 onsite audit day");
        cy.get(".order-pricing").find("price-card").eq(2).find("[id='certification-fee-price-3']").should("have.text", "$ 250");
