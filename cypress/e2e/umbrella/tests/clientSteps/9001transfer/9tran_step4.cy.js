...
describe("9001 transfer - 4th step testcases", function(){

    beforeEach(function(){
        cy.visit("https://stage-iso14001.myaudit.net/system/login");
        cy.get("#email").type("autouser9tran-step4@qq.qq");
    ...
    it("basic validations/contact banner/stepper/downloading PDF", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company9tran4step.pdf').should('exist');
    ...
    it("right hand side - title, files and user data", function(){
        ...
        cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName9tran4step");
    ...
    describe("billing info cases", function(){
        ...
        it("billing info section", function(){
            ...
            cy.wait(5000);
                ...
                cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName9tran4step LastName");
                cy.get("#user-info").find("#user-email").should("have.text", "autouser9tran-step4@qq.qq");
                //check basic info accordion - first/last name and email change shouldn't change basic info data
                cy.get(".order-card").find(".company-name").should("have.text", "Company9tran4step");
                cy.get("#order-details").find("#contact-person").should("have.text", "FirstName9tran4step LastName");
                cy.get("#order-details").find("#email").should("have.text", "autouser9tran-step4@qq.qq");
            ...
            cy.get("input[formcontrolname='email']").clear().type("autouser9tran-step4@qq.qq");
    ...
    describe("edit functionality", function(){
        ...
        it("basic info - edit", function(){
            ...
            cy.get("order-details").find("#change-button").click();
                ...
                cy.get("#hasCertificate_ISO_9001").find(".text").contains("No").click(); //"No" for initial
                cy.get(".audit-type-change-dialog").should("exist");
                cy.get(".audit-type-change-dialog").find(".dialog-buttons").contains("Cancel").click();
                // cy.get("#hasCertificate_ISO_9001").find("input[value='true']").eq(0).should("exist"); //sprawdź czy asercja działa
                // cy.get("#hasCertificate_ISO_9001 input").eq(0).should("have.attr", "value", "true"); //sprawdź czy inaczej zdefiniowana asercja działa
                ...
                cy.get("input[formcontrolname='customCbNameISO_9001']").type("Edit fields");
                /**/
            ...
            cy.get("#terms-and-conditions-first-name").should("have.value", "FirstName9tran4step edit");
            ...
            cy.get(".order-card").find(".company-name").should("have.text", "Company9tran4step edit");
            ...
            it("additional questions - edit", function(){
                ...
                cy.get("#transfer-reason-iso_9001-certificate").type(" and another reason");
                cy.get("#isCurrentCertificationBodyAccredited-iso_9001-certificate").find(".text").contains("Yes").click();
                cy.get("#hasOpenNonConformities-iso_9001-certificate").find(".text").contains("No").click();
