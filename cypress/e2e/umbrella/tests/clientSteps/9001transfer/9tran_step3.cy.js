...
describe("9001 transfer - 3rd step testcases", function(){
    ...
    it("basic validations", function(){
        ...
        cy.get("#binary-question-description-0ISO_9001-iso_9001").type("a");
        cy.get("#binary-question-description-1ISO_9001-iso_9001").type("a");
        cy.get("#binary-question-description-2ISO_9001-iso_9001").type("a");
        cy.get("#binary-question-description-3ISO_9001-iso_9001").type("a");
        cy.get("#binary-question-description-4ISO_9001-iso_9001").type("a");
        cy.get(".binary-questions-wrapper").find("binary-question-with-comment").each(($question)=>{
        ...
        cy.get("product-additional-questions").find(".text-area-wrapper").eq(5).find(".validation-message").should("have.text", "Required");
        cy.get("#text-question-0ISO_9001-iso_9001").type("a");
        cy.get("product-additional-questions").find(".text-area-wrapper").eq(5).find(".validation-message").should("have.text", "Description is too short");
        ...
        cy.get("#outsourced_process_4ISO_9001-iso_9001").type("a");
    ...
    it("contact banner/next audit date/non-comformities/last audit date+cert expiration date", function(){
        ...
        //non-comformities
        cy.get("#hasOpenNonConformities-iso_9001-certificate").find(".text").contains("Yes").click();
        cy.get("#hasCorrectiveActionPlans-iso_9001-certificate").find(".text").contains("Yes").click();
    ...
    it("stepper/downloading PDF/accordion behaviours", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company9tran3step.pdf').should('exist');
        //accordion behaviour
            //pricing
    ...
    it("editing/validating changes", function(){
        ...
        cy.get(".decision-buttons").find("#cancel-button").click();
        cy.get(".order-card").find("#toggle-order-details").click();
        cy.get("#contact-person").should("have.text", "FirstName9tran3step LastName");
//revert comment later        cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName9tran3step LastName");
