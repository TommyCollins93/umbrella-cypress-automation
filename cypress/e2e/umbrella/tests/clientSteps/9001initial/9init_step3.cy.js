...
describe("9001 initial - 3rd step testcases", function(){
    ...
    it("stepper/downloading PDF/accordion behaviours", function(){
        ...
        cy.readFile('cypress\\downloads\\Estimate-Company9init3step.pdf').should('exist');
        //accordion behaviour
            //pricing
    ...
    it("editing/validating changes", function(){
        ...
        cy.get(".decision-buttons").find("#cancel-button").click();
        cy.get(".order-card").find("#toggle-order-details").click();
        cy.get("#contact-person").should("have.text", "FirstName9init3step LastName");
        cy.get("#user-info").find("#user-full-name").should("have.text", "FirstName9init3step LastName");
