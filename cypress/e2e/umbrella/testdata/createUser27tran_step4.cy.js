...
describe("creating user account for iso 27001 transfer - 4th step", function(){

    it("creating user account for iso 27001 transfer - 4th step", function(){
        ...
        cy.get('input[formcontrolname="firstName"]').type("FirstName27tran4step");
        cy.get('input[formcontrolname="lastName"]').type("LastName");
        cy.get('input[formcontrolname="jobTitle"]').type("JobTitle");
        cy.get('input[formcontrolname="email"]').type("autouser27tran-step4@qq.qq");
        cy.get('input[formcontrolname="phone"]').type("(512) 512 -  5122");
        cy.get('input[formcontrolname="companyName"]').type("Company27tran4step");
