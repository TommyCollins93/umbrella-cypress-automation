...
describe("creating user account for iso 27001 transfer - 3rd step", function(){

    it("creating user account for iso 27001 transfer - 3rd step", function(){
        ...
        cy.get('input[formcontrolname="firstName"]').type("FirstName27tran3step");
        cy.get('input[formcontrolname="lastName"]').type("LastName");
        cy.get('input[formcontrolname="jobTitle"]').type("JobTitle");
        cy.get('input[formcontrolname="email"]').type("autouser27tran-step3@qq.qq");
        cy.get('input[formcontrolname="phone"]').type("(512) 512 -  5122");
        cy.get('input[formcontrolname="companyName"]').type("Company27tran3step");
