...
describe("1st step testcases", function(){
    ...
    it("1st step - validation messages - empty state", function(){
    ...
    it("1st step - state field", function(){
    ...
    it("1st step - validation messages - other", function(){
        //first name
